            ...
            <table class="table table-sm bg-light table-bordered table-striped text-center table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle">Rp. <?php echo e($item->harga_jual); ?>,00</td>
...
<!-- /.content -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sim\resources\views/stok/barang/barang_index.blade.php ENDPATH**/ ?>