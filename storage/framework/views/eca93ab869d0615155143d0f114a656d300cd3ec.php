      ...
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <a href="<?php echo e(url('/transaction/purchase/create')); ?>" class="btn btn-primary float-right text-white">Tambah Transaksi Pembelian</a>
          </div>
          <div class="card-body">
...
<!-- /.content -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sim\resources\views/transaksi/pembelian/pembelian_index.blade.php ENDPATH**/ ?>